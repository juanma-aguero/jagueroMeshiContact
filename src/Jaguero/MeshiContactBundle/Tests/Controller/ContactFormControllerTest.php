...
class ContactFormControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/admin/contactform/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'contactform[name]' => 'Lorem ipsum dolor sit amet',
            'contactform[yourName]' => 'Lorem ipsum dolor sit amet',
            'contactform[yourEmail]' => 'Lorem ipsum dolor sit amet',
            'contactform[subject]' => 'Lorem ipsum dolor sit amet',
            'contactform[yourMessage]' => 'Lorem ipsum dolor sit amet',
            'contactform[redirectUrl]' => 'Lorem ipsum dolor sit amet',
            'contactform[toEmail]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/contactform/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'contactform[name]' => 'Changed',
            'contactform[yourName]' => 'Changed',
            'contactform[yourEmail]' => 'Changed',
            'contactform[subject]' => 'Changed',
            'contactform[yourMessage]' => 'Changed',
            'contactform[redirectUrl]' => 'Changed',
            'contactform[toEmail]' => 'Changed',
